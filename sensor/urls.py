...
urlpatterns = [
  ...
  path('arduino_manage/<int:node_id>', views.arduino_manage, name='arduino_manage'),
  path('arduino_add/<int:node_id>', views.arduino_add, name='arduino_add'),
  path('arduino_edit/<int:pk>/<int:node_id>', views.arduino_edit, name='arduino_edit'),
  path('arduino_delete/<int:pk>/<int:node_id>', views.arduino_delete, name='arduino_delete'),
  path('arduino_connection', views.arduino_connection, name='arduino_connection'),
  path('arduino_getdata/<int:arduino_dd>', views.arduino_getdata, name='arduino_getdata'),
  path('choose_connection', views.choose_connection, name='choose_connection'),
