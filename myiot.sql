...
--
-- Triggers `water_level_monitoring_sensor`
--
DELIMITER $$
CREATE TRIGGER `NOTIFICATION` AFTER INSERT ON `water_level_monitoring_sensor` FOR EACH ROW INSERT INTO notification(message,type) VALUES('water_level_monitoring_sensor.level_2_msg',2)
$$
DELIMITER ;
