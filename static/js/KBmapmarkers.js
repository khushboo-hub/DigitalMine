...
jQuery( document ).ready(function() {
	...
	jQuery('body').on('mouseover', '.MinerIcon', function(){

		var clickedMarkerName = $(this).attr('id');
...
function createKBmap(name, mapsrc, mapDataJSON){
	...
	var output = '<div class="KBmap__mapContainer"><div class="KBmap__mapHolder"><img  class="svg" src="' + mapImg + '" alt="mapa"><div class="FullScreenClass hide" id="full_screen" style="left: 1.5%; top: 3.68%"><img src="/static/image/expand.svg"></div></div></div>';
