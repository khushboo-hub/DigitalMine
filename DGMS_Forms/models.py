...
class First_schedule_form_v_Model(models.Model):
    ...
    signature = models.ImageField(upload_to='dgms_annual_report_signature_image/First_Schedule_Form_v/', null=True,blank=False)
...
class extract_or_reduce_pillars_models(models.Model):
    ...
    signature = models.ImageField(upload_to='dgms_annual_report_signature_image/DEPILLARING_PERMISSION/', null=True,blank=False)
