...
class Strata_sensor(models.Model):
    mine_name = models.ForeignKey(MineDetails,on_delete=models.CASCADE,null=True,blank=True)
    location_id = models.ForeignKey(Strata_location,on_delete=models.CASCADE,null=True,blank=True)#models.IntegerField()
    ...
    level_1_msg = models.CharField(max_length=200,null=True,blank=True,default='Strata Condition:First Stage Warning Message , Please be Careful.')
    level_2_msg = models.CharField(max_length=200,null=True,blank=True,default='Strata Condition:Second Stage Warning Message , Please be alert situation is not good.')
    level_3_msg = models.CharField(max_length=200,null=True,blank=True,default='Strata Condition:Third Stage Warning Message , Please  leave the underground')
